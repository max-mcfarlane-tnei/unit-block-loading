...
class TestRunBasicExample(unittest.TestCase):
    ...
    def test_run_basic_example(self):
        ...
        decision_fig, cumulative_cost_fig, active_power_fig, subplot_fig, active_power, c = run_basic_example(
            t=config_experiment.T,
            n=config_experiment.N,
            restart_targets=config_experiment.RESTART_TARGETS,
            block_limit=config_experiment.BLOCK_LIMIT,
    ...
    def test_constraints(self):
        ...
        # Initialize total generation with solar and wind
        gross_generation = solar + wind

        # Dynamically sum the generation from all generators
        # Loop through columns that start with "Generator"
    ...
    def test_initial_generator_status(self):
        ...
        for i in range(config_experiment.N):
